...
activities.update({
    "Basketball Team": {
        "description": "Inter-school basketball team practices and games",
    ...
    "Swimming Club": {
        ...
        "schedule": "Tuesdays, Fridays, 5:00 PM - 6:30 PM",
        "max_participants": 20,
    ...
    "Drama Society": {
        "description": "Theatre productions, acting workshops, and rehearsals",
